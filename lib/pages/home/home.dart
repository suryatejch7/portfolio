...
class _HomeState extends State<Home> with SingleTickerProviderStateMixin {
  ...
  void _onScroll() {
    ...
    if (_titleLocked && _titleUnlockAt != null && DateTime.now().isBefore(_titleUnlockAt!)) {
      return;
    } else {
      _titleLocked = false;
    }
  ...
  double _visibleFraction(GlobalKey key) {
    ...
    final viewportTop = Globals.headerHeight; // below persistent header
